...
> **用途**：生成萧天的角色定妆照/角色卡，用于AI生视频时的人物一致性锁定（Reference图）
...
- 不要发型过于精致打理（萧天是判官不是偶像，发型应该有"自然乱"质感）
```
...
右手食指与中指间夹着一枚银色硬币（直径约2.5cm，正面朝外可见模糊的"判官"字样浮雕，是萧天身份的核心象征），
颈间无项链（保持军人简洁风），
...
Step 2：选定一张最满意的→保存为"萧天主参考图（公开身份）"
Step 3：再用"痞帅浪子版"完整提示词生成3-5张
Step 4：选定一张→保存为"萧天暧昧参考图（私下身份）"
...
| 错误 | 修正 |
|------|------|
| AI把萧天画成韩系小奶狗 | 强调"30岁成熟男性+下颌胡茬+实战疤痕+军人肤色" |
